...
function SpawnSmallBosses()
	...
	for k,v in pairs(pointr) do				
		...
		if filtUnits == 0 then
			...
			--MinimapEvent(DOTA_TEAM_GOODGUYS, nil, location[0], location[1], DOTA_MINIMAP_EVENT_HINT_LOCATION, 5.0)
			--MinimapEvent(DOTA_TEAM_BADGUYS, nil, location[0], location[1], DOTA_MINIMAP_EVENT_HINT_LOCATION, 5.0)
		end
	end
